...
The Social Neuron CLI provides terminal access to the 91 public stdio tools available in the npm package, including two local screen-capture tools. Interactive hosted MCP App tools are not exposed over stdio.
