/**
 * Niche research tool — surfaces QA-gated viral content from content_winners view.
 *
...
export function registerNicheResearchTools(server: McpServer): void {
  server.tool(
    ...
    "Find QA-gated high-performing short-form videos in the project's niche. " +
      ...
      'Backed by content_winners view (qa_score >= 0.5 + replication_prompt populated).',
    {
      ...
      min_qa_score: z
        ...
        .max(1)
        .default(0.5)
        .describe('Minimum QA score (0..1). Default 0.5 matches the content_winners view floor.'),
