  ...
  describe('get_credit_balance', () => {
    ...
    it('returns active subscription credits from user_profiles', async () => {
      setupMocks(
        ...
        { data: { tier: 'pro', status: 'active', monthly_credits: 1500 }, error: null }
      );
    ...
    it('returns JSON envelope when response_format=json', async () => {
      setupMocks(
        ...
        { data: { tier: 'starter', status: 'active', monthly_credits: 500 }, error: null }
      );
    ...
    it('returns correct text format with monthly usage', async () => {
      setupMocks(
        ...
        { data: { tier: 'business', status: 'active', monthly_credits: 5000 }, error: null }
      );
