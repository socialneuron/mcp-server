...
export function registerBrandTools(server: McpServer): void {
  ...
  server.tool(
      ...
      "content for it.",
    {
      url: z
        ...
        .url()
        .describe(
          "The website URL to analyze for brand identity " +
  ...
  server.tool(
    ...
    "Persist a brand profile as the active profile for a project.",
    {
      ...
      change_summary: z
        ...
        .max(500)
        .optional()
        .describe("Optional summary of changes."),
      changed_paths: z
        .array(z.string())
        .optional()
        .describe("Optional changed path list."),
      source_url: z
        .string()
        .url()
        .optional()
        .describe("Optional source URL for provenance."),
      extraction_method: z
        .enum([
          "manual",
          "url_extract",
  ...
  server.tool(
    ...
    async ({
      ...
      const brandContext = {
        ...(existingProfile.brand_context as Record<string, unknown>),
      };
      const voiceProfile =
      ...
      const mergedOverride: Record<string, unknown> = {
        ...
        ...(avoid_patterns !== undefined
          ? { avoidPatterns: avoid_patterns }
          : {}),
        ...(hashtag_strategy !== undefined
