...
export const TOOL_CATALOG: ToolEntry[] = [
  ...
  // niche research
  {
    ...
    description:
      "Find QA-gated high-performing short-form videos in the project's niche. Returns extracted hook patterns, content structures, and pre-compiled replication prompts (backed by content_winners view, qa_score >= 0.5).",
    module: 'research',
    scope: 'mcp:read',
  },
  ...
  // agentic-harness — learning loop write-back
  {
    ...
    description:
      'Persist a verbal reflection for an agent loop. Provenance keys are restricted (quality-guard safety): only content_history_id, outcome_event_id, prm_score_ids, and handoff_ids are accepted.',
    module: 'harness',
    scope: 'mcp:write',
  },
  {
