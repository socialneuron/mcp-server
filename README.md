...
| Lifecycle      | cancel_async_job, cancel_scheduled_post, delete_carousel, delete_content_plan, delete_autopilot_config        | Project-scoped cancellation and cleanup; release acceptance requires the [backend smoke evidence](an internal test plan) |
